...
async def get_auto_complete_suggestions(request: AutoCompleteRequest):
    ...
    try:
        ...
        if field_type == "description":
            suggestions.extend(generate_description_suggestions(context, context_categories, job_title))
        elif field_type == "requirements":
            suggestions.extend(generate_requirements_suggestions(context, context_categories, job_title))
        elif field_type == "summary":
            suggestions.extend(generate_summary_suggestions(context, context_categories, job_title))
